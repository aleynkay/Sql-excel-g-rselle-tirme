...
--En iyi performans gösteren  satis görevlisini listele.
...
--En çok satis yapilan  sehri listele.
...
--Tedarikçi basina toplam satis miktarini ve toplam geliri listele.
...
--Kategori basina toplam satis miktarini ve toplam geliri listele.
...
--Yillara göre toplam satis miktarini ve toplam geliri listele.
...
--Müsteri basina toplam siparis sayisini, toplam harcamayi ve en son siparis tarihini listele.
...
--Çalisan basina toplam siparis sayisini, toplam satis miktarini ve toplam geliri listele.
